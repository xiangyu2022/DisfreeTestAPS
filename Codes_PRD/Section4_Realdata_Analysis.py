...
np.random.seed(1234)
y = np.loadtxt("/Users/zxysmacbook/Downloads/v8/A_hat_linear_v8.txt")
post_func = np.loadtxt("/Users/zxysmacbook/Downloads/v8/A_theta_hat_3_parameters_linear_v8.txt")
Sig = np.loadtxt("/Users/zxysmacbook/Downloads/v8/Sigma_linear_v8.txt")
Jacob = np.loadtxt("/Users/zxysmacbook/Downloads/v8/jacobian_3_parameters_linear_v8.txt")
Sig_inv_sqrt = np.linalg.inv(sqrtm(Sig))
