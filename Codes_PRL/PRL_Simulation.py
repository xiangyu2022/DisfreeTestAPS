...
L = 5
n = N//L
l = np.tile(np.linspace(0,4,num=L),n)
...
np.savetxt("KS_res_y1_L04_df6_100.csv", KS_res_y1, delimiter=",")
np.savetxt("KS_res_y2_L04_df6_100.csv", KS_res_y2, delimiter=",")
np.savetxt("KS_res_y3_L04_df6_100.csv", KS_res_y3, delimiter=",")
np.savetxt("KS_res_y4_L04_df6_100.csv", KS_res_y4, delimiter=",")
np.savetxt("CVM_res_y1_L04_df6_100.csv", CVM_res_y1, delimiter=",")
np.savetxt("CVM_res_y2_L04_df6_100.csv", CVM_res_y2, delimiter=",")
np.savetxt("CVM_res_y3_L04_df6_100.csv", CVM_res_y3, delimiter=",")
np.savetxt("CVM_res_y4_L04_df6_100.csv", CVM_res_y4, delimiter=",")

np.savetxt("KS_rotated_y1_L04_df6_100.csv", KS_rotated_y1, delimiter=",")
np.savetxt("KS_rotated_y2_L04_df6_100.csv", KS_rotated_y2, delimiter=",")
np.savetxt("KS_rotated_y3_L04_df6_100.csv", KS_rotated_y3, delimiter=",")
np.savetxt("KS_rotated_y4_L04_df6_100.csv", KS_rotated_y4, delimiter=",")
np.savetxt("CVM_rotated_y1_L04_df6_100.csv", CVM_rotated_y1, delimiter=",")
np.savetxt("CVM_rotated_y2_L04_df6_100.csv", CVM_rotated_y2, delimiter=",")
np.savetxt("CVM_rotated_y3_L04_df6_100.csv", CVM_rotated_y3, delimiter=",")
np.savetxt("CVM_rotated_y4_L04_df6_100.csv", CVM_rotated_y4, delimiter=",")
...
np.savetxt("KS_N500_L04_boot_asym.csv", KS100, delimiter=",")
np.savetxt("CVM_N500_L04_boot_asym.csv", CVM100, delimiter=",")
